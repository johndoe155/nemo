...
// Final art-direction layer: the Living Archive chapter system. It is loaded
// last so narrative hierarchy and material surfaces win without disturbing the
// section-specific systems above.
